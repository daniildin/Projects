...
do
{
    ...
    case "3":
    // I need to make sure all animals have their age and physical description filled in
    
    for (int i = 0; i < maxPets; i++)
    {
        // If the age is missing, ask the user to provide it
        if (ourAnimals[i, 2] == "Age: ?" && ourAnimals[i, 0] != "ID #: ")
        {
            ...
            while (validEntry == false)
            {
                ...
                if (readResult != null && readResult.Length > 0 && int.TryParse(readResult, out petAge))
                {
                    animalAge = readResult;
                    validEntry = true;
                }
                ...
                {
                    Console.WriteLine("Invalid entry. Please enter a valid number for the age.");
                }
            }
        ...
        // If the physical description is missing, ask the user to provide it
        if (ourAnimals[i, 4] == "Physical description: " && ourAnimals[i, 0] != "ID #: ")
        {
            ...
            while (validEntry == false)
            {
                ...
                {
                    Console.WriteLine("Invalid entry. Please enter a description.");
                }
            }
    ...
    // Let the user know that all data is complete
    Console.WriteLine("\nAll age and physical description fields are now complete. \nPress Enter to continue.");
    Console.ReadLine();
    break;
